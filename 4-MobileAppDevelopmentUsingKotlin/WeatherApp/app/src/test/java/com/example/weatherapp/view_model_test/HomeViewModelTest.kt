...
class HomeViewModelTest {
    ...
    //looper is not mocked, so we use InstantTaskExecutorRule to ensure LiveData updates are executed immediately.
    ...
    fun fetchWeatherData_emitsCurrentAndForecastWeather_whenRepositoryReturnsSuccess() = runTest {
        ...
        viewModel.fetchWeatherData(30.0f, 31.0f, "dummy_ap(), `is`(forecastResponse))
